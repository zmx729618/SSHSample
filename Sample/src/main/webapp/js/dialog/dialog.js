...
//============【psh 开始】==========
lhgdialog.messageSource = {};
lhgdialog.messageSource['en-us'] = [
	['default-title' , 'Title'],
	['alert-title' , 'Alert'],
...
lhgdialog.messageSource['en'] = lhgdialog.messageSource['en-us'];

lhgdialog.messageSource['zh-cn'] = [
	['default-title' , '标题'],
	['alert-title' , '提示'],
	['confirm-title' , '提示'],
	['prompt-title' , '提示'],
 ...
 * @author psh
 */
lhgdialog.getLanguage=function() 
{
	var lang = null;
 ...
 * 获取国际化资源信息
 */
lhgdialog.getMessageSource = function() 
{
	var lang = lhgdialog.getLanguage();
	var messageSource = lhgdialog.messageSource['zh-cn'];
	if(lhgdialog.messageSource[lang]) {
		messageSource = lhgdialog.messageSource[lang];
	}
 ...
 * 国际化
 */
lhgdialog.getI18nMsg = function(key) {
	return lhgdialog.getMessageSource()[key];
};
...
{
	var title=lhgdialog.getI18nMsg('alert-title') ? lhgdialog.getI18nMsg('alert-title') : lhgdialog.getI18nMsg('default-title');
...
{
	var title=lhgdialog.getI18nMsg('confirm-title') ? lhgdialog.getI18nMsg('confirm-title') : lhgdialog.getI18nMsg('default-title');
...
{
	var title=lhgdialog.getI18nMsg('prompt-title') ? lhgdialog.getI18nMsg('prompt-title') : lhgdialog.getI18nMsg('default-title');
...
{
	var title=lhgdialog.getI18nMsg('error-title') ? lhgdialog.getI18nMsg('error-title') : lhgdialog.getI18nMsg('default-title');
	return lhgdialog({
		title: title,
		width : '12em',
		height : '8em',
 ...
 * @author psh
 * @param	{String}	消息内容
 * @param   {Number}    显示时间 (默认2秒)
 */
lhgdialog.ok = function( content, time, callback, parent)
{
	var titleInit="\u63d0\u793a(10秒后自动关闭)";
	var titlePre=lhgdialog.getI18nMsg('success-title') ? lhgdialog.getI18nMsg('success-title') : lhgdialog.getI18nMsg('default-title');
	var msg=lhgdialog.getI18nMsg('close-msg') ? lhgdialog.getI18nMsg('close-msg') : lhgdialog.getI18nMsg('秒后关闭）');
	...
	return lhgdialog({
		...
		resize: false,
		init: function () {
			var that = this, i = time||2;
			var fn = function () {
				that.title(titlePre + i + msg);
				!i && that.close();
				i --;
			};
 ...
 * @param   {Number}    显示时间 (默认2秒)
 */
lhgdialog.success = function(content, callback, time)
{
