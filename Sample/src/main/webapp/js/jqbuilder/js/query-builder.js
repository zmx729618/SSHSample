...
QueryBuilder.DEFAULTS = {
    ...
    operators: [
        ...
        {type: 'yes_in',           nb_inputs: 1, multiple: true,  apply_to: ['string', 'number', 'datetime']},
...
QueryBuilder.defaults({
    ...
    mongoRuleOperators: {
        ...
        $in :     function(v) { return {'val': v.$in, 'op': 'yes_in'}; },
...
QueryBuilder.defaults({
    ...
    sqlRuleOperator: {
        ...
        'IN':       function(v) { return { val: v, op: 'yes_in' }; },
